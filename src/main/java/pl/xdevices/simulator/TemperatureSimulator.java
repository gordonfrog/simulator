...
public class TemperatureSimulator {
    ...
    @Value("${API_HOST:pf4devicesdev1.local}")
    ...
    public void postTemperatureSensor1() {
        ...
        logger.info("*** Temperature Sensor 1 Fired ***");
    }
    ...
    public void postTemperatureSensor2() {
        ...
        logger.info("*** Temperature Sensor 2 Fired ***");
    }
    ...
    public void postTemperatureSensor3() {
        ...
        logger.info("*** Temperature Sensor 3 Fired ***");
    }

    private void postRequestForSensor(String uuid) {
    	String send = buildRandomizedTemperature(uuid);
    	logger.info("Sending: "+send);
        URI uri = restTemplate.postForLocation(send, null);
        logger.info("URI: "+uri);
    }
